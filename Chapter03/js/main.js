...
//define callback function to print megacities data in window
function debugCallback(response){
    //set variable to contain the megacities data
    myData = response
    //add text (stringified) version of value of myData variable to the end of the myDiv object
    document.querySelector("#myDiv").insertAdjacentHTML('beforeend', '<br>GeoJSON data:<br>' + JSON.stringify(myData))

};

//define myData variable (as global variable)
var myData;

//define function to fetch and convert megacities data and call callback function
function debugAjax(){
		
    //fetch data
	fetch("data/MegaCities.geojson")
        //convert data AFTER it has been fetched
		.then(function(response){
			return response.json();
        })
            
        //call callback function AFTER it has been converted
        .then(debugCallback);

};

//call fetching function AFTER the window has loaded
